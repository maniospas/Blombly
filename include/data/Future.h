...
public:
    ...
    void start(Code* code, BMemory* newMemory, ThreadResult* futureResult, Command *command, DataPtr thisObj=nullptr) {
        thread = std::thread(threadExecute, code, newMemory, futureResult, command, thisObj);
    }
};
