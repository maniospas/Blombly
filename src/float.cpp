...
std::shared_ptr<Data> Float::implement(const OperationType operation, const BuiltinArgs& args)  {
    ...
    if (args.size == 2 
        ...
        double v1 = args.arg0->getType() == INT ? static_cast<double>(((Integer*)args.arg0.get())->getValue()) : ((Float*)args.arg0.get())->getValue();
        double v2 = args.arg1->getType() == INT ? static_cast<double>(((Integer*)args.arg1.get())->getValue()) : ((Float*)args.arg1.get())->getValue();
        switch(operation) {
            case EQ: 
