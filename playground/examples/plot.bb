Canvas = {
    final plots = list();
    axes = 255,255,255,255;
    shade = 255,255,255,32;
...
canvas = new{Canvas:}
canvas = canvas.plot(x, y :: color=255,0,0,255; title="first");
canvas = canvas.plot(x, (y|vector-1)^3 :: color=0,255,0,255; title="second");
